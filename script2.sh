...
#after the column in the same .txt file. Lines of this file contain data about Provinicias and its expenses when using fuel, carbones,..
...
#data of the year and month and the emount of particular expense in a file named after it and puts it in the apropriate directory.
